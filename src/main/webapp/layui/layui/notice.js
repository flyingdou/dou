...
layui.define(['jquery'], function(exports) {
  var $ = layui.jquery;
  var cssStyle = $('<style type="text/css">.notices-group{position: fixed; right: 0px; top: 0; z-index: 9999999;} .layui-notice{width: 300px; right: 10px; z-index: 9999; position: relative;} .layui-notice-right{margin-left: 0px; margin-right: 15px;} .notice{position: relative; margin-bottom: auto; color: #fff; padding: .75rem 1.25rem; top: auto;} .notice i{margin-right: 5px;} .notice a{color: rgba(255, 255, 255, 0.8);} .notice a:hover{color: white;} .notice .has-border{border: 1px solid #ecedf2 !important;} .notice .text-left{text-align: left;} .notice .text-right{text-align: right;} .notice .text-center{text-align: center;} .notice .pull-left{float: left;} .notice .pull-right{position: absolute; top: 8px; right: 5px;} .has-radius{border-radius: 5px !important;} .layui-bg-green2{background-color: #52c41a !important;} .layui-bg-yellow{background-color: #FFB800 !important;} .layui-bg-grey{background-color: #768093 !important;}</style>');
  ...
  var noticeObj = {
    ...
    init: function($data) {
      ...
      var noticeObjHtml = '<div class="layui-container layui-anim layui-anim-scaleSpring layui-notice"><div class="notice ' + classN_ + ' has-radius">';
