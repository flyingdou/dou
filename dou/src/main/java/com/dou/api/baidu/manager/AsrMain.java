...
import com.dou.common.ConnUtil;
import com.dou.common.Constant;
import com.dou.common.DemoException;
import com.dou.common.TokenHolder;
...
public class AsrMain {
    ...
    private final String APP_KEY = Constant.BAIDU_API_KEY;

    // 填写网页上申请的APP SECRET 如 $SECRET_KEY="94dc99566550d87f8fa8ece112xxxxx"
    private final String SECRET_KEY = Constant.BAIDU_SECRET_KEY;

    // 需要识别的文件
    private final String FILENAME = "D://Java/test/16k.pcm";
...
//    }
    ...
    */
    ...
    public static void main(String[] args) throws IOException, DemoException, JSONException {
        ...
        log.info("start_time: {}", EasyUtils.dateFormat(new Date(), "yyyy-MM-dd HH:mm:ss.SSS"));
        // 填写下面信息
        String result = demo.run();
        log.info("end_time: {}", EasyUtils.dateFormat(new Date(), "yyyy-MM-dd HH:mm:ss.SSS"));
